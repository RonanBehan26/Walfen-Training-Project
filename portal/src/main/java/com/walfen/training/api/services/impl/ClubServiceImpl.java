...
public class ClubServiceImpl implements ClubService {
	...
	@Override
	public List<PlayerDto> listPlayers(Long id) {

		List<PlayerDto> playersListOne = new ArrayList<>();

		PlayerDto playerOne = new PlayerDto("Tony", "Johnson", LocalDate.parse("1989-11-14"), "Back", 18);
		PlayerDto playerTwo = new PlayerDto("John", "Patrick", LocalDate.parse("1989-11-14"), "Forward", 10);
