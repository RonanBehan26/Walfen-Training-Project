...
public class testStadium {
	...
	President presidentTeamTest = new President(
			"Pat", 
			"Dunbarr", 
			LocalDate.parse("1956-11-14"), 
			LocalDate.parse("1975-11-14"), 
			dutiesTest);
	
	Coach coachTeamTest = new Coach(
			"John", 
			"Pine", 
			LocalDate.parse("1954-12-19"), 
			LocalDate.parse("1983-01-10"));
	
	
	Player playerT1P1Test = new Player(
			"Mike", 
			"Testman", 
	...
	Player playerT1P2Test = new Player(
			"Harry", 
			"Testerman", 
			LocalDate.parse("1993-11-14"), 
			"Back", 
			0);
	
	Player playerT1P3Test = new Player(
			"Paul", 
			"Testford", 
			LocalDate.parse("1983-12-12"), 
			"Mid-Field", 
			16);
	...
	Club clubTest = new Club(
			"JohnsVille", 
			LocalDate.parse("1924-11-14"), 
			presidentTeamTest, 
			coachTeamTest, 
			playersTest);
